...
public record VersionDetails(String id, String normalizedVersion, String releaseTime, boolean client, boolean server, boolean sharedMappings, Downloads downloads) implements Comparable<VersionDetails> {
